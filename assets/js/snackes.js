let snackesMinus = document.querySelectorAll('.snackes-minus');
let snackesPlus = document.querySelectorAll('.snackes-plus');

snackesMinus.forEach(min => {
