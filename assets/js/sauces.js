let saucesMinus = document.querySelectorAll('.sauces-minus');
let saucesPlus = document.querySelectorAll('.sauces-plus');

saucesMinus.forEach(min => {
