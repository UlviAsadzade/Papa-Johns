let papadiasMinus = document.querySelectorAll('.papadias-minus');
let papadiasPlus = document.querySelectorAll('.papadias-plus');

papadiasMinus.forEach(min => {
